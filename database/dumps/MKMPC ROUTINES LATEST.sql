...
--
-- Host: localhost    Database: mkmpc_aug
-- ------------------------------------------------------
...
--
-- Table structure for table `aivon`
--

DROP TABLE IF EXISTS `aivon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aivon` (
  `hawb_no` varchar(15) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `aivon`
--

LOCK TABLES `aivon` WRITE;
/*!40000 ALTER TABLE `aivon` DISABLE KEYS */;
/*!40000 ALTER TABLE `aivon` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'mkmpc_aug'
--

--
-- Dumping routines for database 'mkmpc_aug'
--
...
-- Dump completed on 2025-12-09 14:44:06
