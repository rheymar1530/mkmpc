...
(function ($) {
  ...
  $container.append(
    '<h5>Customize Webview</h5><hr class="mb-2"/>'
  )
  ...
  function update_settings(key_val,value){

    var value_settings = {};
    value_settings[key_val] = value;
    console.log({value_settings})
    $.ajax({
      type            :        'POST',
      url             :        '/admin/post/user_settings',
      data            :        {'settings' : value_settings},
