			...
			<div class="modal-content " style="">
				...
				<div class="form-horizontal" id="submit_filter">   
					<div class="form-group row" style="margin-top:15px">
						...
						<div class="col-sm-4">
							<input type="date" title="Date" required="" class="form-control opt_sel form-in-text option_1" id="txt_date_from_fil"  disabled="" value="<?php echo e($date_from); ?>">
						</div>
						<div class="col-sm-4">
							<input type="date" title="Date" required="" class="form-control opt_sel form-in-text option_1" id="txt_date_to_fil"  disabled="" value="<?php echo e($date_to); ?>">
						</div>
					</div>
					<div class="form-group row" style="margin-top:8px">
						<label class="radio col-sm-2">
							<input type="radio" name="optradio" value='2' <?php echo ($fil_type == 2)?"checked":""; ?>>
							<span class="control-label">CDV #</span>
						</label>
						<div class="col-sm-4">
							<input type="text" title="Date" required="" class="form-control opt_sel form-in-text option_2" id="txt_cdv_no_search"  disabled="" value="<?php echo e($cdv_search); ?>">
						</div>
...
<script type="text/javascript">
	...
	$('#filter_target').submit(function(e){
		...
		if(val == 1){ // date
			...
			filter_data['cdv_search'] = $('#txt_cdv_no_search').val();
		}
		var location_reload = PARENT_ROUTE+'?'+$.param(filter_data);
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/cash_disbursement/filter_option_modal.blade.php ENDPATH**/ ?>