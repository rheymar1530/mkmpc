        ...
        <div class="modal-content">
            <form id="frm_cancel_repayment">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4">Cancel Loan Payment ID# <?php echo e($repayment_transaction->id_repayment_transaction ?? ''); ?> 
...
<script type="text/javascript">
    ...
    function post_cancel(){
        $.ajax({
            ...
            data       :          {'id_repayment_transaction'  : '<?php echo e($repayment_transaction->id_repayment_transaction); ?>',
                                  ...
                                  hide_loader();
                                    if(response.RESPONSE_CODE == "SUCCESS"){
                                        ...
                                        Swal.fire({
                                            ...
                                            icon: 'success',
                                            showCancelButton : true,
                                            confirmButtonText: 'Loan Payment ID# '+'<?php echo e($repayment_transaction->id_repayment_transaction); ?>',
                                            showDenyButton: false,
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/repayment/cancel_modal.blade.php ENDPATH**/ ?>