            ...
            <table id="tbl_chart_account" class="table table-hover table-striped" style="white-space: nowrap;margin-top: 10px;">
                ...
                <tbody id="list_body">
                	<?php $__currentLoopData = $charts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                		<tr class="chart_row" data-chart-id="<?php echo e($chart->id_chart_account); ?>">
                			<td><?php echo e($chart->id_chart_account); ?></td>
                			<td><?php echo e($chart->account_code); ?></td>
                			<td><?php echo e($chart->description); ?></td>
                			<td><?php echo e($chart->cat_desc); ?></td>
                			<td><?php echo e($chart->line_desc); ?></td>
                			<td><?php echo e($chart->cred_deb_description); ?></td>
                			<td><?php echo e($chart->type_description); ?></td>
                			<td><?php echo e($chart->sub_type); ?></td>
                			<td>
                				<?php if($chart->status != ""): ?>
...
<?php echo $__env->make('accounting.chart_of_account_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e(URL::asset('dist/js/pickup_request/pickup_request.js')); ?>" type='text/javascript'></script>
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/accounting/chart_of_account.blade.php ENDPATH**/ ?>