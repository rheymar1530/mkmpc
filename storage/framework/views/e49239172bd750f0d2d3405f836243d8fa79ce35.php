...
?>
<div class="px-4">
	<h2 class="mt-n4 lbl_color">Modules</h2>
		...
		<div class="col-lg-5 d-flex  mt-2">
			<div class="card flex-fill card-cust">
				<!-- <div class="card-header border-0 div_center">
					<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Loan Application</span></h1>
				</div> -->
				<div class="card-body">
					<div class="text-center mb-4">
						<h4 class="head_lbl">Loan Application</h4>
					</div>
					<?php echo $__env->make('dashboard.loan_application', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
			</div>
		</div>
...
<!-- 				<div class="card-header border-0 div_center">
					<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Loan Loan Payment</span></h1>
				</div> -->
				<div class="card-body">
					<div class="text-center mb-4">
						<h4 class="head_lbl">Loan Loan Payment</h4>
					</div>
					<?php echo $__env->make('dashboard.repayment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-6">
			<div class="row p-0">
				<div class="col-lg-12 first_o mt-4">
					<div class="card">
						<!-- <div class="card-header border-0 div_center">
							...
							<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Cash Transactions</span></h1>
						</div> -->
						<div class="card-body">
							<div class="text-center mb-3">
								<h4 class="head_lbl">Cash Transactions</h4>
							</div>
							<?php
							$content = array(
								array('description'=>'IN','icon'=>'in.png','col'=>2,'width'=>'40px','font-size'=>'25px','class'=>'f-big'),
								array('description'=>'Receive Payment/Contribution','icon'=>'payment.png','col'=>4,'href'=>'/cash_receipt/add'),
							...
							<div class="row">
								...
								<div class="col-lg-<?php echo e($con['col']); ?> col-<?php echo e($con['col']); ?> div_center">
									<a href="<?php echo e($con['href'] ?? 'javascript:void(0)'); ?>" style="font-size: <?php echo $con['font-size']??'' ?> "> <span class="badge badge-lbl bg-light rounded-pill <?php echo e($con['class']??''); ?>"><?php echo e($con['description']); ?></span></a>
								</div>
							...
							<div class="row">
								<?php $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-lg-<?php echo e($con['col']); ?> col-<?php echo e($con['col']); ?> div_center">
									<a href="<?php echo e($con['href'] ?? 'javascript:void(0)'); ?>"><img src="<?php echo e(URL::asset('dist/icons/'. $con['icon']  )); ?>" width="<?php echo e(($con['width'])??80); ?>px" height="80px" ></a>
								</div>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</div>	
				...
				<div class="col-lg-12 fourth_o mt-4">
					<div class="card">
						<!-- <div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Bank</span></h1>
						</div> -->
						<div class="card-body">
							<div class="text-center mb-4">
								<h4 class="head_lbl">Bank</h4>
							</div>
							<?php
							$content = array(
							...
							<div class="row mt-2">
								<?php $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-lg-<?php echo e($con['col']); ?> col-<?php echo e($con['col']); ?> div_center">
									<a href="<?php echo e($con['href'] ?? 'javascript:void(0)'); ?>" style="font-size: <?php echo $con['font-size']??'' ?> "><span class="badge badge-lbl bg-light rounded-pill"> <?php echo e($con['description']); ?></span></a>
								</div>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</div>
							<!-- END LABEL -->								
				...
				<div class="col-lg-12 fifth_o mt-4">
					<div class="card">
						<!-- <div class="card-header border-0 div_center">
							...
							<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Employee</span></h1>
						</div> -->
						<div class="card-body">
							<div class="text-center mb-3">
								<h4 class="head_lbl">Employee</h4>
							</div>
							<?php
							$content = array(
		...
		<div class="col-lg-6">
			<div class="row p-0">
				<div class="col-lg-12 third_o mt-4" id="div_accounting">
					<div class="card">
						<!-- <div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Accounting</span></h1>
						</div> -->
						<div class="card-body">
							<div class="text-center mb-4">
								<h4 class="head_lbl">Accounting</h4>
							</div>
							<?php
							$content = array(
								array('description'=>'Journal Voucher','icon'=>'journal voucher.png','col'=>4,'href'=>'/journal_voucher/create'),
								array('description'=>'Chart of Accounts','icon'=>'chart of accounts.png','col'=>4,'href'=>'/charts_of_account'),
								array('description'=>'Financial Statement','icon'=>'financial statement.png','col'=>4,'href'=>'/financial_statement/comparative'),
							);
							?>			
							<!-- ICONS -->
							<div class="row mt-1">
							...
							<?php
							$content = array(
								array('description'=>'General Ledger','icon'=>'general ledger.png','col'=>4,'href'=>'/accounting/general_ledger'),
								array('description'=>'Trial Balance','icon'=>'reports CBU.png','col'=>4,'href'=>'/accounting/trial_balance')
							);
							?>					
				...
				<div class="col-lg-12 fifth_o mt-4" id="div_asset">
					<div class="card">
						<!-- <div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Assets</span></h1>
						</div> -->
						<div class="card-body">
							<div class="text-center mb-4">
								<h4 class="head_lbl">Assets</h4>
							</div>
							<?php
							$content = array(
...
<!-- 						<div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Reports</span></h1>
						</div> -->
						<div class="card-body">
							<div class="text-center mb-3">
								<h4 class="head_lbl">Reports</h4>
							</div>
							<?php
							$l =5;
							$content = array(
								...
								array('description'=>'','icon'=>'reports journal.png','col'=>6,'sub'=>array(
									...
									['description'=>'Cash-out Summary','href'=>'/journal/report/cash_disbursement'],
									['description'=>'Voucher Summary','href'=>'/voucher_summary'],
									
								)),
								array('description'=>'','icon'=>'reports CBU.png','col'=>6,'sub'=>array(
									['description'=>'Total CBU','href'=>'/cbu/report'],
							...
							<div class="row mt-1">
								<?php $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-lg-<?php echo e($con['col']); ?> col-6 div_center p-0">
									<div class="col-lg-12">
										<a href="<?php echo e($con['href'] ?? 'javascript:void(0)'); ?>"><img src="<?php echo e(URL::asset('dist/icons/'. $con['icon']  )); ?>" width="<?php echo e(($con['width'])??80); ?>px" height="80px"></a>
									</div>
									<div class="col-lg-12 mt-3">
										<ul class="main_list">
											<?php for($i=0;$i<$l;$i++): ?>
											<?php if(isset($con['sub'][$i]['description'])): ?>
											<!-- <li class="mt-1"> -->
												<div class="row mb-1">

													<div class="col-lg-12 div_left">
														<a class="a_label" style="font-size: <?php echo $con['font-size']??'' ?>" href="<?php echo e($con['sub'][$i]['href'] ?? ''); ?>"><span class="badge badge-lbl bg-light rounded-pill text-left"> <?php echo e($con['sub'][$i]['description'] ?? ''); ?></span></a>
													</div>
	...
	<div class="row div_dashboard">
		<div class="col-lg-12 fourth_o mt-4">
			<div class="card">
				<!-- <div class="card-header border-0 div_center">
					<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Maintenance</span></h1>
				</div> -->
				<div class="card-body">
							<div class="text-center mb-4">
								<h4 class="head_lbl">Maintenance</h4>
							</div>
					<?php
					$l =4;
					$content = array(
							...
							<div class="col-lg-12 mt-3">
								<ul class="main_list">
									...
									<?php if(isset($con['sub'][$i]['description'])): ?>
										...
										<div class="row mb-2">
											<div class="col-lg-12 div_left">
												<a class="a_label" style="font-size: <?php echo $con['font-size']??'' ?>" href="<?php echo e($con['sub'][$i]['href'] ?? ''); ?>"><span class="badge badge-lbl bg-light rounded-pill"> <?php echo e($con['sub'][$i]['description'] ?? ''); ?></span></a>
											</div>
								...
								<ul class="main_list">
									...
									<li>
										<div class="row">
											...
											<div class="col-lg-12 div_left">
												<a class="a_label" style="font-size: <?php echo $con['font-size']??'' ?>" href="<?php echo e($con['sub'][$i]['href'] ?? ''); ?>"> <?php echo e($con['sub'][$i]['description'] ?? ''); ?></a>
											</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>