					...
					<div class="table">
						<table class="table table-bordered table-head-fixed tbl_loan w-100" id="tbl_loan">
							...
							<tbody class="borders bmember" data-member-id="<?php echo e($id_member); ?>">
								...
								<tr class="rloan" data-loan="<?php echo e($lo->loan_token); ?>" data-id="<?php echo e($lo->id_loan); ?>" loan-due="<?php echo e($lo->statement_amount); ?>" rp-id="<?php echo e($lo->id_repayment_statement_details); ?>">
									<?php if($c == 0): ?>
									...
									<td class="font-weight-bold nowrap text-right"><?php echo e(number_format($lo->previous,2)); ?></td>
									<td class="font-weight-bold nowrap text-right"><?php echo e(number_format($lo->current,2)); ?></td>
									<td class="font-weight-bold nowrap text-right"><?php echo e(number_format($lo->surcharge,2)); ?></td>
									<td class="text-right "><?php echo e(number_format($lo->statement_amount,2)); ?></td>
							...
							<tfoot>
								...
								<?php $__currentLoopData = $keysTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<td class="text-right"><?php echo e(number_format($totalsKey[$k],2)); ?></td>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
