...
<div class="container-fluid main_form" style="margin-top:-20px">
	...
	<div class="row">
		<div class="col-md-12">
			<table id="tbl_rc" class="table table-hover table-striped" style="margin-top: 10px;">
				<thead>
				...
				<tbody id="list_body">
					<?php $__currentLoopData = $repayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr class="repayment-row" data-code="<?php echo e($list->id_repayment); ?>">
						<td class="text-center"><?php echo e($list->id_repayment); ?></td>
						<td><?php echo e($list->or_number); ?></td>
						<td><?php echo e($list->payment_for); ?></td>
						...
						<td>
							...
							<span class="badge badge-<?php echo e(status_class($list->status)); ?> text-xs">
...
$(function() {
	$.contextMenu({
		...
		callback: function(key, options) {
			...
			if(key == "view"){
				window.location = '/repayment-bulk/view/'+id_repayment +'?href='+'<?php echo e(urlencode(url()->full())); ?>';
			}else if(key == "edit"){
				window.location = '/repayment-bulk/edit/'+id_repayment +'?href='+'<?php echo e(urlencode(url()->full())); ?>';
			}else if(key == "print"){
...
function redirect_add(){
	window.location = '/repayment-bulk/create'+'?href='+'<?php echo e(urlencode(url()->full())); ?>';
}
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/repayment-bulk/index.blade.php ENDPATH**/ ?>