		...
		<table class="tbl-mngr" width="100%">
			...
			<tbody>
				...
				<tr class="rloan">
					...
					<td class="font-weight-bold nowrap class_amount"><?php echo e(number_format($lo->previous,2)); ?></td>
					<td class="font-weight-bold nowrap class_amount"><?php echo e(number_format($lo->current,2)); ?></td>
					<td class="font-weight-bold nowrap class_amount"><?php echo e(number_format($lo->surcharge,2)); ?></td>
					<td class="class_amount"><?php echo e(number_format($lo->statement_amount,2)); ?></td>
					<?php
			...
			<footer>
				<tr>
					...
					<th class="class_amount"><?php echo e(number_format($totalsKey[$k],2)); ?></th>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
