                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-12">
                       ...
                       <select class="form-control form-control-border" id="sel-employee-type">
                           ...
                           <?php $__currentLoopData = $employeeType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $et): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <option value="<?php echo e($et->id_employee_type); ?>"><?php echo e($et->description); ?></option>
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/payroll/master_list.blade.php ENDPATH**/ ?>