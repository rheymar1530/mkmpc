                    ...
                    <div class="card c-border">
                        <div class="card-body">
                            ...
                            <table class="tbl_fields_style lbl_color">
                                <?php $__currentLoopData = $additional_compensation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th width="50%"><?php echo e($ac['label']); ?></th>
                                    <td><input type="text" class="form-control class_amount in_add_compensation in_employee_amounts" value="0.00" id="txt_<?php echo e($ac['key']); ?>" key="<?php echo e($ac['key']); ?>"  parent-class="in_add_compensation"></td>
                                </tr>
                ...
                <div class="col-md-12 p-0">
                    ...
                    <div class="card c-border">
                        <div class="card-body">
                            ...
                            <table class="tbl_fields_style lbl_color">
                                <?php $__currentLoopData = $employee_deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th width="50%"><?php echo e($ad['label']); ?></th>
                                    <td><input type="text" class="form-control class_amount in_employee_deduction in_employee_amounts" value="0.00" id="txt_<?php echo e($ad['key']); ?>" key="<?php echo e($ad['key']); ?>" parent-class="in_employee_deduction"></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border-top: 2px solid;">
                                    <th width="50%">Sub Total</th>
                            ...
                            ?>
                            <table class="tbl_fields_style lbl_color"> 
                                <?php $__currentLoopData = $deducted_benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $db): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th width="50%"><?php echo e($db['label']); ?></th>
                                    <td><input type="text" class="form-control class_amount  in_deducted_benefits in_employee_amounts" value="0.00" id="txt_<?php echo e($db['key']); ?>" key="<?php echo e($db['key']); ?>" parent-class="in_deducted_benefits"></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border-top: 2px solid;">
                                    <th width="50%">Sub Total</th>
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/payroll/payroll_employee_modal.blade.php ENDPATH**/ ?>