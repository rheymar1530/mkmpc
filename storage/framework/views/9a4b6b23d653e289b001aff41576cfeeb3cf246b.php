                                    ...
                                    <tr class="row_deduction">
                                        <td>
                                            <select class="form-control form-control-border frm-requirements p-0 fee-type">
                                                <?php $__currentLoopData = $loan_fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($lf->id_loan_fees); ?>"><?php echo e($lf->name); ?></option>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/loan/other_deduction.blade.php ENDPATH**/ ?>