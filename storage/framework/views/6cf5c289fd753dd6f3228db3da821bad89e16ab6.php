	...
	<div class="card">
		<div class="card-body">
			<div class="text-center mb-5">
				<h5 class="head_lbl">Loan Overdue</h5>
			</div>
			<form>
...
<script type="text/javascript">
	const ExportData = (type) =>{
		...
		window.open(`/loan-overdue/export/${$t}?`+$.param($query),'_blank');
	}
	...
	const Generate = ()=>{
		...
		window.location = `/loan-overdue?`+$.param($query);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/loan-overdue/index.blade.php ENDPATH**/ ?>