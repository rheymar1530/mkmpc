			...
			<div class="modal-content " style="">
				...
				<div class="form-horizontal" id="submit_filter">   
					...
					<div class="form-group row" style="margin-top:8px">
						...
						<div class="col-sm-4">
							<input type="text" title="Date" required="" class="form-control opt_sel form-in-text option_2" id="txt_jv_no_search"  disabled="" value="<?php echo e($jv_search); ?>">
						</div>
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/journal_voucher/filter_option_modal.blade.php ENDPATH**/ ?>