...
<table class="table table-bordered table-head-fixed" id="tbl_overdues" width="100%">
	...
	<thead>
		<tr class="nb-bottom">
			...
			<th class="table_header_dblue" colspan="3" <?php echo $style; ?>><b>INTEREST AS OF <?php echo e(strtoupper($asOf)); ?></b></th>
		...
		?>
			<?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c=>$loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<tr class="<?php echo e($class); ?>" tk="<?php echo e($exportMode==0?$loan->loan_token:0); ?>">
					...
					<?php endif; ?>
					<td><?php echo e($loan->{$reference}); ?> &nbsp;
						<?php if($type < 3): ?><a <?php echo $ref;?> ><sup>[<?php echo e($loan->id_loan); ?>]</sup></a><?php endif; ?></td>
					...
					<td class="class_amount"><?php echo e(number_formats($loan->interest_amount)); ?></td>
					<td class="class_amount"><?php echo e($loan->month); ?></td>
					<td class="class_amount"><?php echo e(number_formats($loan->interest_total)); ?></td>
					<td class="class_amount"><?php echo e(number_formats($loan->surcharge_total)); ?></td>
					<td class="class_amount"><?php echo e(number_formats($loan->total,2)); ?></td>
					<td class="class_amount"><?php echo e(number_formats($loan->payment)); ?></td>
			...
			<?php if(count($loans) > 1): ?>
				...
				<tr class="bbottom">
					...
					<td></td>
					<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($Stotal['interest_amount'])); ?></td>
					<td></td>
					<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($Stotal['interest_total'])); ?></td>
					<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($Stotal['surcharge_total'])); ?></td>
					<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($Stotal['total'])); ?></td>
					<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($Stotal['payment'])); ?></td>
	...
	<tr class="btop">
		...
		<td></td>
		<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($totals['interest_amount'])); ?></td>
		<td></td>
		<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($totals['interest_total'])); ?></td>
		<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($totals['surcharge_total'])); ?></td>
		<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($totals['total'])); ?></td>
		<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($totals['payment'])); ?></td>
		<td class="class_amount" style="font-weight: bold"><?php echo e(number_formats($totals['balance'])); ?></td>

	</tr>
</table><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/loan-overdue/table.blade.php ENDPATH**/ ?>