...
<div class="modal fade" id="cancel_jv_modal" tabindex="-1" role="dialog" aria-labelledby="booking" aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="form_cancel_submit">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4">JV ID#  <?php echo e($jv_details->id_journal_voucher); ?>
...
<script type="text/javascript">
    var to_be_cancel_holder = '<?php echo e($jv_details->id_journal_voucher); ?>';
    ...
    function show_cancel_modal(){
        ...
        $('#cancel_jv_modal').modal('show');
    }
    function post_cancel(){
        $.ajax({
            type          :          "POST",
            url           :          "/journal_voucher/cancel",
            data          :          {"id_journal_voucher"  :   to_be_cancel_holder,
            ...
            success       :          function(response){
                                     ...
                                     if(response.RESPONSE_CODE == "SUCCESS"){
                                        Swal.fire({
                                            title: "JV Successfully Cancelled",
                                            text: '',
                                            icon: 'success',
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/journal_voucher/cancellation_modal.blade.php ENDPATH**/ ?>