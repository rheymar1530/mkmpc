...
<div class="modal fade" id="cancel_cdv_modal" tabindex="-1" role="dialog" aria-labelledby="booking" aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="form_cancel_submit">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4">CDV ID#  <?php echo e($cdv_details->id_cash_disbursement); ?>
...
<script type="text/javascript">
    var to_be_cancel_holder = '<?php echo e($cdv_details->id_cash_disbursement); ?>';
    ...
    function show_cancel_modal(){
        ...
        $('#cancel_cdv_modal').modal('show');
    }
    function post_cancel(){
        $.ajax({
            type          :          "POST",
            url           :          "/cdv/cancel",
            data          :          {"id_cash_disbursement"  :   to_be_cancel_holder,
                                      "cancel_reason"    :   $('#txt_cancel_reason').val(),
                                      'type'            :   '<?php echo e($route); ?>'},
            beforeSend    :          function(){
                                     show_loader()
            },
            success       :          function(response){
                                     ...
                                     if(response.RESPONSE_CODE == "SUCCESS"){
                                        Swal.fire({
                                            title: "CDV Successfully Cancelled",
                                            text: '',
                                            icon: 'success',
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/cash_disbursement/cancellation_modal.blade.php ENDPATH**/ ?>