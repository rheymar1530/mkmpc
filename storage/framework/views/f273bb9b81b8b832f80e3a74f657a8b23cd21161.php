...
<select class="form-control col-md-3" id="sel_input_mode">
	<?php $__currentLoopData = $input_mode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<option value="<?php echo e($val); ?>" <?php echo($val==$selected_in)?"selected":""; ?>><?php echo e($desc); ?></option>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/repayment/payment_table.blade.php ENDPATH**/ ?>