	...
	<div class="row">
       <div class="col-md-12">
            <table id="tbl_cdv" class="table table-hover table-striped" style="white-space: nowrap;margin-top: 10px;">
                ...
                <tbody id="list_body">
                	<?php $__currentLoopData = $cdv_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                		<tr class="jv_row" data-code="<?php echo e($list->id_cash_disbursement); ?>">
                			<td><?php echo e($list->id_cash_disbursement); ?></td>
                			<td><?php echo e($list->date); ?></td>
                			<td><?php echo e($list->payee_type); ?></td>
                			<td><?php echo e($list->payee); ?></td>
                			<td><?php echo e($list->description); ?></td>
                			<td class="class_amount"><?php echo e(number_format($list->total,2)); ?></td>
...
<?php echo $__env->make('cash_disbursement.filter_option_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
var PARENT_ROUTE = '/cdv'+'/<?php echo e($route); ?>';
...
$(function() {
    $.contextMenu({
        ...
        callback: function(key, options) {
			...
			if(key == "view"){
				window.location = PARENT_ROUTE+'/view/'+id_cash_disbursement +'?href='+'<?php echo e(urlencode(url()->full())); ?>';
			}else if(key == "print"){
				print_page('/cash_disbursement/print/'+id_cash_disbursement)
			}
        },
        items: {
        	"view": {name: "View "+'<?php echo e($title_mod); ?>', icon: "fas fa-eye"},
...
function redirect_add(){
	window.location = PARENT_ROUTE+'/create'+'?href='+'<?php echo e(urlencode(url()->full())); ?>';
}
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#tbl_cdv_filter').append('<a class="btn bg-gradient-info" onclick="redirect_add()" style="float:left"><i class="fa fa-plus"></i>&nbsp;Create '+'<?php echo e($title_mod); ?>'+'</a>')
	})
</script>
<?php endif; ?>
<script type="text/javascript">
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/cash_disbursement/index.blade.php ENDPATH**/ ?>