        ...
        <div class="modal-content">
            <form id="frm_submit_or">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4">Print OR Loan Payment ID# <?php echo e($repayment_transaction->id_repayment_transaction); ?> </h5>    
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="txt_or_no" value="<?php echo e($repayment_transaction->or_no ?? ''); ?>" required>
                            </div>
                        </div> 
                    </div>
                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/repayment/repayment_or.blade.php ENDPATH**/ ?>