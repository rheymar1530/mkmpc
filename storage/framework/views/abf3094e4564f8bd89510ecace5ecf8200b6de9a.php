                        ...
                        <div class="form-row" style="margin-top:10px">
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control p-0" id="sel_status">
                                    <?php $__currentLoopData = $status_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
function post_status(){
    $.ajax({
        ...
        data       :       {'id_cbu_withdrawal' : '<?php echo e($details->id_cbu_withdrawal ?? 0); ?>',
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/cbu_withdraw/withdraw_status.blade.php ENDPATH**/ ?>