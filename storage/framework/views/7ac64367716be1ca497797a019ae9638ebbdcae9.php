	...
	<div class="row">
		<div class="col-md-12">
			<table id="tbl_deposit" class="table-hover table-striped" style="margin-top: 10px;">
				...
				<tbody id="list_body">
					<?php $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr class="repayment-row" data-code="<?php echo e($list->id_check_deposit); ?>">
						<td class="text-center"><?php echo e($list->id_check_deposit); ?></td>
						<td><?php echo e($list->date_deposited); ?></td>
						<td><?php echo e($list->bank_name); ?></td>
						<td><?php echo e($list->check_nos); ?></td>
						<td><?php echo e($list->remarks); ?></td>
						<td class="text-right"><?php echo e(number_format($list->amount,2)); ?></td>
...
$(function() {
	$.contextMenu({
		...
		callback: function(key, options) {
			...
			if(key == "view"){
				window.location = '/check-deposit/view/'+id_check_deposit +'?href='+'<?php echo e(urlencode(url()->full())); ?>';
			}else if(key == "edit"){
				window.location = '/check-deposit/edit/'+id_check_deposit +'?href='+'<?php echo e(urlencode(url()->full())); ?>';
			}else if(key == "print"){
...
function redirect_add(){
	window.location = '/check-deposit/create'+'?href='+'<?php echo e(urlencode(url()->full())); ?>';
}
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/check_deposit/index.blade.php ENDPATH**/ ?>