						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control p-0" id="sel_type">
									<?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($val); ?>" <?php echo($sel_type == $val)?"selected":""; ?> ><?php echo e($tl); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class="form-control p-0" id="sel_pay_to_from">
									...
									<?php $__currentLoopData = $pay_to_from_op; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($val); ?>" <?php echo($val==$pay_to_from)?'selected':''; ?>><?php echo e($p); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
							<div class="col-md-4">
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/transaction_summary/index.blade.php ENDPATH**/ ?>