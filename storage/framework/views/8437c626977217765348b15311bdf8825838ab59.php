			...
			<div class="card-body">
					...
					<div class="row d-flex align-items-end">
						<div class="form-group col-md-2">
							...
							<select class="form-control form-control-border p-0" name="type" id="sel-type">
								<?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($val); ?>" <?php echo($val==$selected_type)?'selected':''; ?>><?php echo e($type); ?></option>
						...
						<div class="form-group col-md-1 div-monthly">
							...
							<select class="form-control form-control-border p-0" name="year" id="sel-year">
								<?php for($i=$year_start;$i<=$current_year;$i++): ?>
						...
						<div class="form-group col-md-2 div-daily">
							...
							<input type="date" class="form-control form-control-border" id="txt-date" name="date" value="<?php echo e($selected_day); ?>">
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<?php echo $__env->make('treasurer_report.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	const ExportData = (type) =>{
		...
		$query = {
			...
			'type' : <?php echo e($selected_type); ?>,
			'date' : '<?php echo e($selected_day); ?>'
		};
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/treasurer_report/index.blade.php ENDPATH**/ ?>