		...
		<div class="column border-right" id="col-grp-1" style="padding:0px !important;">
		 	<table class="table_width add_border" style="" border="0" cellspacing="0" cellpadding="0">
		 		...
		 		<tbody>
		 			...
		 			?>
		 			<tr>
		 				 <td class="table-column f-item"><div class="item <?php echo e($add_class); ?> table_column_1_width_item add_border"><?php echo isset($cash_receipt_details[$i-1])?$cash_receipt_details[$i-1]->payment_description:"" ?></div></td>
		 				 <td class="table-column f-item"><div class="item <?php echo e($add_class); ?> table_column_2_width_item add_border text-right amt"><?php echo isset($cash_receipt_details[$i-1])?number_format($cash_receipt_details[$i-1]->amount,2):"&nbsp;" ?></div></td>
		 			</tr>
		 			<?php endfor; ?>
					...
					<tr>
		 				 <td class="table-column f-item"><div class="item hp5 table_column_1_width_item add_border"></div></td>
		 				 <td class="table-column f-item"><div class="item hp5 table_column_2_width_item add_border text-right amt">&nbsp;<?php echo e(number_format($cash_receipt->total_payment,2)); ?></div></td>
		 			</tr>
		 		</tbody>
		 	...
		 	<table class="table_width add_border" style="" border="0" cellspacing="0" cellpadding="0">
		 		<tr>
		 				<!-- cash -->
		 				<td class="table-column" style="width:3cm !important;"><div class="item add_border item-paymode" style="width:3cm !important;padding-left: 8.5mm;padding-top: 5mm;"><?php echo e(($cash_receipt->id_paymode==1)?'x':''); ?></div></td>
		 				<!-- bank -->
		 				<td class="table-column"><div class="item add_border item-paymode" style="padding-left:0.5mm;padding-top: 1.5mm;"><?php echo e(($cash_receipt->id_paymode==3)?'x':''); ?></div></td>
		 		</tr>
		...
		<div class="column border-right add_border" id="col-grp-2" style="padding:0px !important">
			<table class="or_details add_border" style="" border="0" cellspacing="0" cellpadding="0">
			        ...
			        <tr>
		 				 ...
		 				 <td class="table-column" style="width:3.3cm"><div class="item add_border item_62"><?php echo e($cash_receipt->transaction_date); ?></div></td>
		 			</tr>

		 			<!-- Received From -->
		 			<tr>
		 				 <!-- <td class="table-column" style="width:2.2cm"><div class="item item_6 add_border"></div></td> -->
		 				 <td class="table-column" colspan="3"><div class="item add_border item_6" style="padding-left: 2.3cm;"><?php echo e($cash_receipt->member_name); ?></div></td>
		 			</tr>

		 			<!-- With TIN -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item add_border item_55" style="padding-left: 1.5cm;"><?php echo e($cash_receipt->tin); ?></div></td>
		 			</tr>	

		 			<!-- Address   -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item item_55 add_border" style="padding-left: 2.6cm;"><?php echo e($cash_receipt->address); ?></div></td>
		 			</tr>	 			

		 			<!-- Engaged in -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item item_6 add_border" style="padding-left: 5.2cm;"><?php echo e($cash_receipt->engaged_in); ?></div></td>
		 			</tr>	
...
</html><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/cash_receipt/new_or.blade.php ENDPATH**/ ?>