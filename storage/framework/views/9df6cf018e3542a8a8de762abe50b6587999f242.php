...
/*			letter-spacing: 1px;*/
		...
		.border-w-border{
			border : 1px #d6dee1 solid !important;
		}
		...
		tr.bb td{
			border-top: 1px #d6dee1 solid!important;
/*			font-color `-*/
		}
		.nowrap{
			white-space: nowrap;
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/repayment-report/pdf.blade.php ENDPATH**/ ?>