	 	...
	 	<div class="card card-primary">
            ...
            <div class="card-body clearfix">
                    ...
                    <div class='form-group'>
                        ...
                        <input type='text' class='form-control' name='name' required id="prev_name" value="<?php echo e($details->name ?? ''); ?>"/>
                    </div>
                     	 ...
                     	 <table class='table table-striped table-hover table-bordered' id="tbl_prev">
                     	 	...
                     	 	<tbody>
                     	 		...
                     	 		<?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                ...
	                                ?>
                     	 			<tr class="row_prev">
	                     	 			<td class="col_id" style="display: none"><?php echo e($menu->id); ?></td>
	                                    <td><?php echo e($i); ?></td>
	                                    <td><?php echo e($menu->name); ?></td>
	                                    <td class='info' align="center"><input type='checkbox' title='Check All Horizontal'  class='select_horizontal'/>
	                                    </td>

	                                    <td class='info' align="center"><input type='checkbox'   class='is_view' <?php echo e($check_is_view); ?>/>
	                                    </td>

	                                    <td class='info' align="center"><input type='checkbox'   class='is_create' <?php echo e($check_is_create); ?>/>
	                                    </td>

	                                    <td class='info' align="center"><input type='checkbox'   class='is_read' <?php echo e($check_is_read); ?>/>
	                                    </td>

	                                    <td class='info' align="center"><input type='checkbox'   class='is_update' <?php echo e($check_is_update); ?>/>
	                                    </td>

	                                    <td class='info' align="center"><input type='checkbox'   class='is_delete' <?php echo e($check_is_delete); ?>/>
	                                    </td>

	                               		<td class='info' align="center"><input type='checkbox'   class='is_confirm' <?php echo e($check_is_confirm); ?>/>
                                        <td class='info' align="center"><input type='checkbox'   class='is_confirm2' <?php echo e($check_is_confirm2); ?>/>
                                    	</td>
                                        <td class='info' align="center"><input type='checkbox'   class='is_cancel' <?php echo e($check_is_cancel); ?>/>
                                        </td>
	                                    <td class='info' align="center"><input type='checkbox'   class='is_print' <?php echo e($check_is_print); ?>/>
	                                    </td>
                                	</tr>
                                	<?php $i++;?>
...
<?php $__env->startPush('scripts'); ?>
	<script type="text/javascript">
        ...
        function post(){
            ...
            $.ajax({	
                type               :    'POST',
                url                :    '<?php echo e(URL::to('/admin/privilege/post')); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/privilege/privilege_form.blade.php ENDPATH**/ ?>