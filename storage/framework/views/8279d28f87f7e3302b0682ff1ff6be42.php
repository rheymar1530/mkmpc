	...
	<div class="row">
		<div class="col-md-12">
			<table id="tbl_cbu_request" class="table table-hover table-striped" style="white-space: nowrap;margin-top: 10px;">
				...
				<tbody id="list_body">
					<?php $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr class="cbu_request_row" data-code="<?php echo e($list->id_cbu_withdrawal); ?>" cdv-id="<?php echo e($list->id_cash_disbursement); ?>">
						<td><?php echo e($list->id_cbu_withdrawal); ?></td>
						<td><?php echo e($list->member); ?></td>
						<td><?php echo e($list->mode); ?></td>
						<td><?php echo e($list->reason); ?></td>

						<td class="class_amount"><?php echo e(number_format($list->amount,2)); ?></td>
						...
						?>
						<td><span class="badge badge-<?php echo e($class); ?> text-xs"><?php echo e($list->status); ?></span></td>
...
<?php echo $__env->make('cbu_withdraw.export_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(function() {
	$.contextMenu({
		...
		callback: function(key, options) {
			...
			if(key == "view"){
				window.location = '/cbu_withdraw/view/'+id_cbu_withdrawal +'?href='+'<?php echo e(urlencode(url()->full())); ?>';
			}
			else if(key == "print"){
...
function redirect_add(){
	window.location = '/cbu_withdraw/create'+'?href='+'<?php echo e(urlencode(url()->full())); ?>';
}
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/cbu_withdraw/index.blade.php ENDPATH**/ ?>