	...
	<div class="row">
		<div class="col-md-12">
			<table id="tbl_repayment_transaction" class="table table-hover table-striped" style="white-space: nowrap;margin-top: 10px;">
				...
				<tbody id="list_body">
					<?php $__currentLoopData = $repayment_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr class="repayment_transaction_row" data-code="<?php echo e($list->repayment_token); ?>">
						<td><?php echo e($list->id_repayment_transaction); ?></td>
						<td><?php echo e($list->repayment_date); ?></td>
						<td><?php echo e($list->loan_due_date); ?></td>
						<td><?php echo e($list->paymode); ?></td>
						<td><?php echo e($list->member_name); ?></td>
						<td><?php echo e($list->or_no); ?></td>
						<td class="class_amount"><?php echo e($list->swiping_amount); ?></td>
						<td class="class_amount"><?php echo e($list->total_payment); ?></td>
						<td class="class_amount"><?php echo e($list->change); ?></td>
						<td>
...
<?php echo $__env->make('repayment.filter_option_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('repayment.summary_date_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(function() {
	$.contextMenu({
		...
		callback: function(key, options) {
			...
			if(key == "view"){
				window.location = '/repayment/view/'+repayment_token +'?href='+'<?php echo e(urlencode(str_replace("show_print=1","",url()->full()))); ?>';
			}
		},
		items: {
...
function redirect_add(){
	window.location = '/repayment/create'+'?href='+'<?php echo e(urlencode(str_replace("show_print=1","",url()->full()))); ?>';
}
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/repayment/index.blade.php ENDPATH**/ ?>