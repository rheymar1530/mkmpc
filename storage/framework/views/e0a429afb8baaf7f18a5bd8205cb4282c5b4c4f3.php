	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-md-12">
						<h4 class="head_lbl text-center mb-4"><?php echo e($mod_title); ?></h4>
						...
						<div class="form-group row mt-3">
							...
							<div class="col-md-3">
								<select class="form-control p-0" id="sel_rpt">
									<?php $__currentLoopData = $report_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$rt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($val); ?>" <?php echo ($val==$financial_report_type)?'selected':''; ?> ><?php echo e($rt); ?></option>
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control p-0" id="sel_type">
									<?php $__currentLoopData = $type_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($val); ?>" <?php echo($type == $val)?"selected":""; ?> ><?php echo e($tl); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
						</div>
						<div class="form-group row" id="div_monthly">
							...
							<div class="col-md-2">
								<select class="form-control p-0" id="sel_month_end">
									<?php $__currentLoopData = $month_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$md): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($val); ?>" <?php echo ($val==$end_month)?"selected":""; ?>><?php echo e($md); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
							<div class="col-md-1">
								<select class="form-control" id="sel_year">
									...
									<option value="<?php echo e($i); ?>" <?php echo ($i==$year)?"selected":""; ?>><?php echo e($i); ?></option>
									<?php endfor; ?>
								</select>
							</div>
						...
						<div class="form-group row" id="div_yearly">
							...
							<div class="col-md-2">
								<select class="form-control" id="sel_year_end">
									<?php for($i=2022;$i<=2050;$i++): ?>
									<option value="<?php echo e($i); ?>"  <?php echo ($i==$end_year)?"selected":""; ?>><?php echo e($i); ?></option>
									<?php endfor; ?>
								</select>
							</div>
...
<?php echo $__env->make('adminLTE.admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/financial_statement/index.blade.php ENDPATH**/ ?>