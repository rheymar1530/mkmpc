...
<!-- jQuery -->
<script src="<?php echo e(URL::asset('plugins/jquery/jquery.min.js')); ?>" type='text/javascript'></script>
<!-- Bootstrap -->

<script src="<?php echo e(URL::asset('plugins/bootstrap/js/bootstrap.bundle.min.js')); ?>" type='text/javascript'></script>
<!-- AdminLTE -->
<script src="<?php echo e(URL::asset('dist/js/adminlte.js')); ?>" type='text/javascript'></script>
<script src="<?php echo e(URL::asset('plugins/sweetalert2/sweetalert2.min.js')); ?>" type='text/javascript'></script>
<!-- Toastr -->
<script src="<?php echo e(URL::asset('plugins/toastr/toastr.min.js')); ?>" type='text/javascript'></script>


<!--DATA TABLE-->
<script src="<?php echo e(URL::asset('plugins/datatables/jquery.dataTables.min.js')); ?>" type='text/javascript'></script>
...
<!-- OPTIONAL SCRIPTS -->
<script src="<?php echo e(URL::asset('plugins/chart.js/Chart.min.js')); ?>" type='text/javascript'></script>

<script src="<?php echo e(URL::asset('plugins/chart.js/Chart-label.js')); ?>" type='text/javascript'></script>
<script src="<?php echo e(URL::asset('plugins/chart.js/Chart-data-labels.js')); ?>" type='text/javascript'></script>

<!-- <script src="<?php echo e(URL::asset('dist/js/demo.js')); ?>" type='text/javascript'></script> -->
...
<script src="<?php echo e(URL::asset('plugins/inputmask/jquery.inputmask.min.js')); ?>"></script>
...
<!-- Bootstrap Switch -->
<script src="<?php echo e(URL::asset('plugins/bootstrap-switch/js/bootstrap-switch.min.js')); ?>"></script>
<!-- BS-Stepper -->
<script src="<?php echo e(URL::asset('plugins/bs-stepper/js/bs-stepper.min.js')); ?>"></script>
<!-- dropzonejs -->
<script src="<?php echo e(URL::asset('plugins/dropzone/min/dropzone.min.js')); ?>"></script>

<!-- Context Menu -->

<script src="<?php echo e(URL::asset('plugins/context-menu/js/context-menu.js')); ?>"></script>
<script src="<?php echo e(URL::asset('plugins/context-menu/js/context-menu-ui-position.js')); ?>"></script>
...
<!-- lightbox -->
<script src="<?php echo e(URL::asset('plugins/ekko-lightbox/ekko-lightbox.js')); ?>"></script>
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/adminLTE/plugins.blade.php ENDPATH**/ ?>