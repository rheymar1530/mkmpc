	...
	<div class="card c-border">
		<div class="card-body">
			...
			<div class="col-md-12">
				...
				<hr class="separator">
				<div class="form-row form_check">
					<?php echo $__env->make('loan_service.netpay', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
				<hr class="separator">
				<div class="form-row form_check">
					<div class="form-group col-md-6">
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/loan_service/condition.blade.php ENDPATH**/ ?>