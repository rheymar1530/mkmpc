				...
				<div class="form-horizontal" id="submit_filter">   
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							...
							<select class="form-control p-0" id="sel_filter_type" name="filter_type">
								<?php $__currentLoopData = $filter_type_selection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($val); ?>" <?php echo ($selected_filter_type == $val)?"selected":""; ?> ><?php echo e($desc); ?></option>
					...
					<div id="fil_form_date">
						<div class="form-group row">
							...
							<div class="col-md-4">
								<input type="date" title="Date" required="" class="form-control opt_sel form-in-text" id="txt_fil_date_from"  value="<?php echo e($date_start); ?>" name="date_start">
							</div>
							<div class="col-md-4">
								<input type="date" title="Date" required="" class="form-control opt_sel form-in-text" id="txt_fil_date_to"  value="<?php echo e($date_end); ?>" name="date_end">
							</div>
						</div>
						<div class="form-group row" id="div_rec_from">
							...
							<div class="col-md-3">
								<select class="form-control p-0" name="receive_from" id="receive_from">
									...
									<?php $__currentLoopData = $receive_from; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($k); ?>" <?php echo ($k == $selected_receive_from)?"selected":""; ?> ><?php echo e($r); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="form-group row" id="fil_form_or">
						...
						<div class="col-md-4">
							<input type="text" title="OR No" required="" class="form-control opt_sel form-in-text" id="txt_fil_or"  value="<?php echo e($or_no); ?>" name="or_no">
						</div>
					</div>
					<div id="fil_form"></div>				
				</div>
...
<?php /**PATH C:\wamp64\www\maasin_live_act\resources\views/cash_receipt/filter_option_modal.blade.php ENDPATH**/ ?>