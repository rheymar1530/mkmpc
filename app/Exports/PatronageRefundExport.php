...
class PatronageRefundExport implements FromView, WithEvents,ShouldAutoSize,WithColumnFormatting,WithHeadingRow
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        $data = $this->data;
        // dd($data);
        return view('patronage_refunds.excel-create',$data);
