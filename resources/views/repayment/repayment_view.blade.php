									...
									<table class="table table-bordered table-stripped table-head-fixed tbl-inputs table-hover" style="" width="100%">
										...
										<tbody id="loan_dues_body">
											...
											<tr>
												...
												?>
												<td>ID#<a href="/loan/application/approval/{{$act->loan_token}}">{{$act->id_loan}}</a> {{$act->loan_name}}</td>
												<td class="class_amount">{{number_format($act->paid_principal,2)}}</td>
												<td class="class_amount">{{number_format($act->paid_interest,2)}}</td>
												<td class="class_amount">{{number_format($act->paid_fees,2)}}</td>
												<td class="class_amount">{{number_format($act->surcharges,2)}}</td>
										...
										<tfoot>
											<tr class="foot_loan">
												...
												<td class="class_amount text_bold tbl-inputs-text">{{number_format($total_surcharges,2)}}</td>
...
<!-- 												<tr>
												...
												<tr class="row_swiping_amount">
													...
													<td class="class_amount" width="30%" id="spn_swiping_amount" style="font-weight:bold">{{number_format($swiping_amount,2)}}</td>
													<td></td>
												</tr>
												@endif
											<!-- 	<tr>
												...
												<tr>
													...
													<td class="class_amount" width="30%" id="spn_loan_dues">{{number_format($total_paid_loan,2)}}</td>
													<td></td>
												</tr>
												<tr>
													<td class="spn_t"><span style="font-weight: normal !important;padding-left: 15px;">Loan Penalty/Surcharges</span></td>
													<td class="class_amount" width="30%" id="spn_surcharges">{{number_format($total_surcharges,2)}}</td>
													<td></td>
												</tr>
												<tr>
													<td class="spn_t"><span style="font-weight: normal !important;padding-left: 15px;">Other Fees and Charges</span></td>
													<td class="class_amount" width="30%" id="spn_oth_fee_charg">{{number_format(($total_other+$total_penalties),2)}}</td>
													<td></td>
												</tr>
												<tr style="border-top: 1px solid;">
													<td class="spn_t" ></td>
													<td class="class_amount" width="30%" id="spn_total_paid_amount" style="font-weight:bold">{{number_format($total_paid_amount,2)}}</td>
													<td></td>
												</tr>
												@if($repayment_transaction->transaction_type == 2)
												<tr class="row_swiping_amount">
