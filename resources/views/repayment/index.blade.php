...
$(function() {
	$.contextMenu({
		...
		callback: function(key, options) {
			...
			if(key == "view"){
				window.location = '/repayment/view/'+repayment_token +'?href='+'{{ urlencode(str_replace("show_print=1","",url()->full())) }}';
			}
		},
		items: {
...
function redirect_add(){
	window.location = '/repayment/create'+'?href='+'{{ urlencode(str_replace("show_print=1","",url()->full())) }}';
}
