	...
	<div class="container-fluid main_form section_body" style="margin-top: -20px;" >
		...
		<div class="card" id="repayment_main_div">
					...
					<div class="col-md-12 row">	
						<div class="col-md-12">
							<div class="form-row">
								<div class="form-group col-md-3" style="margin-top:20px">
									...
									<input type="date" name="" class="form-control" value="{{$repayment_transaction->transaction_date ?? $current_date}}" id="txt_transaction_date" min="{{$min_date}}" onkeydown="return false">
								</div>
								<div class="form-group col-md-3" style="margin-top:20px">
							...
							<div class="form-row" id="div_swiping_amount_holder">
								<div id="">
									...
									<div class="form-group col-md-3 div_or">
										...
										<input type="text" name="" required class="form-control" id="txt_or_rep" value="{{$repayment_transaction->or_no ?? ''}}">
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-12" style="margin-top:20px">
							<div class="form-group col-md-12 p-0" style="margin-bottom:unset;">
								@include('repayment.active_loans')
								@include('repayment.payment_table')
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-8">
									<div class="col-md-12 p-0">
										<h5>Other Charges&nbsp;&nbsp;@if($allow_post)<button class="btn btn-sm bg-gradient-primary" onclick="append_penalty()"><i class="fa fa-plus"></i>&nbsp;Add</button>@endif</h5>
			...
			<div class="card-footer">
				...
				<button type="button" class="btn bg-gradient-danger float-right" style="margin-right:10px" onclick="print_page('/journal_voucher/print/{{$repayment_transaction->id_journal_voucher}}')" id="btn_entry"><i class="fas fa-print" ></i>&nbsp;Print Journal Voucher (JV #{{$repayment_transaction->id_journal_voucher}})</button>
				@else
				@if($repayment_transaction->id_cash_receipt_voucher > 0)
				<button type="button" class="btn bg-gradient-danger float-right" style="margin-right:10px" onclick="print_page('/cash_receipt_voucher/print/{{$repayment_transaction->id_cash_receipt_voucher}}')" id="btn_entry"><i class="fas fa-print" ></i>&nbsp;Print CRV (CRV #{{$repayment_transaction->id_cash_receipt_voucher}})</button>
				@endif
				@endif
