		...
		<div class="card-body">
			...
			<div class="col-md-12">
				...
				<div style="max-height: calc(100vh - 200px);overflow-y: auto;margin-top: 5px !important;overflow-x: auto" id="attachment_body">
					...
					@foreach($attachments as $count=>$att)
					<div class="card card-no-shadow div_attachment c-border" data-id="{{$att->id_cdv_attachments}}">
						<div class="card-body" style="padding-bottom:0px !important">
							<div class="row p-0" style="margin-top:-20px">
								...
								<h5 style="margin-top:-20px">Attachment <span class="attachment_count">{{$count+1}}</span></h5>
							</div>
							<div class="form-group col-md-12 file_path_show" style="margin-top: 10px;">
								<span><a href="/storage/uploads/cdv_attachments/{{$att->path_file}}" target="_blank">{{$att->file_name}}</a></span> 
