...
<div class="col-md-12">
	<div class="card c-border">
		<div class="card-body" style="padding-bottom: 0px !important;">
			<h5 class="lbl_color text-center mb-4">{{$alt_title}} Entry</h5>
				...
				<table class="table table-bordered table-stripped table-head-fixed tbl_entry" style="white-space: nowrap;">
					<thead>
						<tr>
							...
							<th class="table_header_dblue" width="500px">{{$alt_title}} Account</th>
...
<script type="text/javascript">
	$('#frm_post_entry').submit(function(e){
		...
		if(totals['credit'] != totals['debit']){
			Swal.fire({
				title: "Total amount of "+'{{strtolower($title_mod)}}'+' is not balance',
				text: '',
				icon: 'warning',
				showCancelButton : false,
				showConfirmButton : false,
