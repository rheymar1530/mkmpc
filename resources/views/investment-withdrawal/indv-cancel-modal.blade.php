        ...
        <div class="modal-content">
            <form id="frm_status_update">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4">Cancel Withdrawal
                    </h5>
...
<script type="text/javascript">
    ...
    let ID_INVESTMENT_WITHDRAWAL_IN_x = 0;
    function cancel_withdrawal(id_investment_withdrawal){
        ID_INVESTMENT_WITHDRAWAL_IN_x = id_investment_withdrawal;
    ...
    function post_status(){
       ...
       $data = {
        'id_investment_withdrawal' : ID_INVESTMENT_WITHDRAWAL_IN_x,
        'reason' :  $('#txt_cancel_reason').val(),

    };
    $.ajax({
        type      :      'POST',
        url       :      '/investment-withdrawal/cancel-ind',
        data      :      $data,
        beforeSend :     function(){
           show_loader();
       },
