...
<div class="container-fluid main_form section_body" style="margin-top:-15px">
	...
	<div class="row">
		...
		<a class="btn bg-gradient-secondary btn-sm" href="{{$back_link}}" style="margin-bottom:10px"><i class="fas fa-chevron-circle-left"></i>&nbsp;&nbsp;Back to Loan Service List</a>
		<div class="card">
			<form id="frm_loan_service">
				<div class="card-body">
					<h3 class="head_lbl text-center mb-3">Loan Service @if($opcode==1) ({{$details->id_loan_service}})  @endif</h3>
					<div class="row">
						<div class="col-md-6" id="div_loan_service_parent">
							...
							<div class="row">
								...
								<div class="col-md-12 p-0">
										...
										<div class="card-body">
											...
											<div class="form-group col-md-5">
												...
												<select class="form-control parent_loan_service p-0 loan_service" id="sel_status" key="status">
													@foreach($status_list as $val=>$text)
													<option value="{{$val}}" <?php echo ($val == $details->status)?"selected":""; ?> >{{$text}}</option>
													@endforeach
												</select>
											</div>
											@endif
												...
												<div class="form-row form_check">
													<div class="form-group col-md-5">
														...
														<select class="form-control parent_loan_service p-0 loan_service" id="sel_disbursement_type" key="id_disbursement_type">
															@foreach($disbursement_type as $dis)
															<option value="{{$dis->id_disbursement_type}}">{{$dis->description}}</option>
															@endforeach
														</select>
													</div>
													<div class="form-group col-md-5">
														...
														<select class="form-control parent_loan_service p-0 loan_service" id="sel_status" key="id_membership_type">
															...
															<option value="{{$m->id_membership_type}}"
																<?php
																if($opcode ==0){
														...
														<div class="form-group col-md-7">
															...
															<select class="form-control parent_loan_service p-0 loan_service" id="sel_terms_condition" key="id_terms_condition">
																...
																<option value="{{$tc->id_terms_condition}}">{{$tc->description}}</option>
																@endforeach
															</select>
														</div>
													...
													<div class="form-row form_check">
														<div class="form-group col-md-6">
															...
															<select class="form-control parent_loan_service p-0 loan_service" id="sel_interest_method" key="id_interest_method">
																@foreach($interest_method as $int)
																<option value="{{$int->id_interest_method}}">{{$int->description}}</option>
																@endforeach
															</select>
														</div>
														<div class="form-group col-md-6">
															...
															<select class="form-control parent_loan_service p-0 loan_service" id="sel_payment_type" key="id_loan_payment_type">
																@foreach($loan_payment_type as $pay)
																<option value="{{$pay->id_loan_payment_type	}}">{{$pay->description}}</option>
																@endforeach
															</select>
														</div>
													</div>
													...
													<div class="form-row form_check" id="div_period">
														...
														<div class="form-group col-md-4">
															...
															<select class="form-control parent_loan_service p-0 loan_service" id="sel_one_type" key="id_one_time_type">
																@foreach($one_time_type as $ot)
																<option value="{{$ot->id_one_time_type}}" <?php echo (($details->id_one_time_type ?? 0) == $ot->id_one_time_type)?"selected":""; ?> >{{$ot->description}}</option>
																@endforeach
															</select>
														</div>
														<div class="form-group col-md-4">
															...
															<select class="form-control parent_loan_service p-0 loan_service sel_period" id="sel_start_month_period" key="start_month_period">
																...
																<option value="{{$val}}" <?php echo ($selected_period_start == $val)?"selected":"" ?> >{{$month}}</option>
																@endforeach
															</select>
														</div>
														<div class="form-group col-md-4">
															...
															<select class="form-control parent_loan_service p-0 loan_service sel_period" id="sel_end_month_period" key="end_month_period">
																@foreach($months as $val=>$month)
																<option value="{{$val}}" <?php echo ($selected_period_end == $val)?"selected":"" ?>>{{$month}}</option>
																@endforeach
															</select>
														</div>
														<div class="form-group col-md-6">
														...
														<div class="form-row form_check">
															<div class="form-group col-md-4">
																...
																<select class="form-control parent_loan_service p-0 loan_service" key="id_term_period" id="sel_term_period">
																	...
																	<option value="{{$per->id_period}}" <?php echo ($per->id_period == 3)?'selected':'' ?> >{{$per->description}}</option>
																	@endforeach
																</select>
															</div>
															<div class="form-group col-md-4">
															...
															<div class="form-group col-md-4">
																...
																<select class="form-control parent_loan_service p-0 loan_service" key="id_repayment_period">
																	@foreach($repayment_period as $rep_per)
																	<option value="{{$rep_per->id_repayment_period}}" <?php echo ($rep_per->id_repayment_period == 2)?'selected':'' ?>>{{$rep_per->description}}</option>
																	@endforeach
																</select>
															</div>
														</div>
									...
									@include('loan_service.charges')
									@include('loan_service.condition')
									@include('loan_service.requirements')
							...
							<div class="col-md-6">
								<div id="div_term_period">
									@include('loan_service.terms')
									@include('loan_service.period')	
											...
											<div class="card-body">
												...
												<div class="row mt-3">
													<div class="form-group col-md-6">
														...
														<input type="text" class="form-control parent_loan_service loan_service col_number" value="{{$details->ls_interest_rate ?? 0}}" key="ls_interest_rate">
													</div>
													<div class="form-group col-md-6">
														<label class="lbl_color mb-0">Loan Protection</label>
														<input type="text" class="form-control parent_loan_service loan_service col_number" value="{{$details->ls_loan_protection ?? 0}}" key="ls_loan_protection">
													</div>
												</div>
											</div>
										</div>
	...
	<script type="text/javascript">
		...
		//SET THE OPTION FORM CHARGES
			...
			$('#sel_repayment_schedule').val({{$details->repayment_schedule ?? 1}})
