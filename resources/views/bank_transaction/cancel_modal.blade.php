...
<div class="modal fade" id="cancel_bt_modal" tabindex="-1" role="dialog" aria-labelledby="booking" aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="form_cancel_submit">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4">Cancel Bank Transaction ID#  {{$transactions->id_bank_transaction}}
...
<script type="text/javascript">
    var to_be_cancel_holder = '{{$transactions->id_bank_transaction}}';
    ...
    function show_cancel_modal(){
        ...
        $('#cancel_bt_modal').modal('show');
    }
    function post_cancel(){
        $.ajax({
            type          :          "POST",
            url           :          "/bank_transaction/cancel",
            data          :          {"id_bank_transaction"  :   to_be_cancel_holder,
            ...
            success       :          function(response){
                                     ...
                                     if(response.RESPONSE_CODE == "SUCCESS"){
                                        Swal.fire({
                                            title: "Bank Transaction Successfully Cancelled",
                                            text: '',
                                            icon: 'success',
