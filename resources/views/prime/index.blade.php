...
<div class="container main_form section_body" style="margin-top: -20px;">
	<div class="card">
		<div class="card-body">
			<h2 class="text-center head_lbl">Prime</h2>
			...
			<div class="row mt-4">
				...
				<!-- <form> -->
					...
					?>
					<div class="col-md-12">
						<h5>Total Prime:&nbsp;&nbsp;&nbsp;<span id="spn_prime_total"></span></h5>
						<div class="table-responsive" style="max-height: calc(100vh - 200px);overflow-y: auto;margin-top: 5px !important;overflow-x: auto">
							<table class="table table-bordered table-stripped table-head-fixed tbl_prime" style="white-space: nowrap;">
								<thead>
									<tr>
								...
								<tbody id="net_body">
									...
									<tr>
										...
										?>
										<td class="class_amount">{{amount($total)}}</td>
									</tr>
									@endforeach
								</tbody>
								<tfoot>
									<tr>
										...
										<td class="class_amount">₱{{number_format($sum_debit,2)}}</td>
										<td class="class_amount">₱{{number_format($sum_credit,2)}}</td>
										
										<th class="class_amount"></th>
									</tr>
								</tfoot>
							</table>    
						</div>  
	...
	<script type="text/javascript">
		...
		function export_excel(){
			...
			window.open('/prime/account-export?'+$.param(queryParam),'_blank');
		}
	</script>
	@endpush