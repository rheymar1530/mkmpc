		...
		<form id="generate_summary">
			<div class="modal-content " style="">
				<div class="modal-header panel_header">
					<h4 class="modal-title"><i class="fa fa-eye"></i> Prime Withdrawal Summary</h4>
...
<script type="text/javascript">
	...
	$('#generate_summary').submit(function(e){
		...
		print_page('/prime_withdraw/export/'+$('#txt_date_summary_start').val()+'/'+$('#txt_date_summary_end').val());
