			...
			<div class="card">
				<div class="card-body">
					<div class="text-center">
						<h4 class="head_lbl mb-3">Bulk Loan Payment @if($opcode==1)<small>(ID# {{$details->id_repayment}})</small>@endif</h4>
					</div>
					...
					<table class="table table-bordered table-head-fixed tbl_pdc w-100" id="tbl_loan">
						<thead>
							<tr class="text-center">
								...
								<th id="spn-rep-type">@if($opcode==1)@if($details->payment_for == 1) Amortization @else Statement Amount @endif @endif</th>
								<th>Payment</th>
								<th width="4%"></th>
							</tr>
						</thead>
						...
						<tfoot>
							<tr>
								...
								<th class="footer_fix text-right"  style="background: #808080 !important;color: white;" id="txt-principal">{{number_format(0,2)}}</th>
								<th class="footer_fix text-right"  style="background: #808080 !important;color: white;" id="txt-interest">{{number_format(0,2)}}</th>
								
								<th class="footer_fix text-right"  style="background: #808080 !important;color: white;" id="txt-surcharge">{{number_format(0,2)}}</th>
								<th class="footer_fix text-right"  style="background: #808080 !important;color: white;" id="txt-balance">{{number_format(0,2)}}</th>
								<th class="footer_fix text-right"  style="background: #808080 !important;color: white;" id="txt-ref">{{number_format(0,2)}}</th>
							...
							<div class="card-body px-5">
								...
								<div class="form-row mt-4">
									<div class="form-group col-md-3">
										...
										<input type="date" class="form-control form-control-border frm-payment-details" value="{{$details->date ?? MySession::current_date()}}" name="date">
									</div>	
									<div class="form-group col-md-3">
										<label class="lbl_color text-sm mb-0">OR No.</label>
										<input type="text" class="form-control form-control-border frm-payment-details" value="{{$details->or_number ?? ''}}" name="or_number">
									</div>	
									<div class="form-group col-md-4">
					...
					<div id="div-payment-type">
						@include('repayment-bulk.payment_types')
					</div>
...
@include('repayment-bulk.payment-for-modal')
@endsection
