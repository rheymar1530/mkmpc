	...
	<div class="card-body px-5">
		...
		<div class="row mt-2">
			...
			<div class="form-group col-md-3 col-12">
				...
				<input type="text" class="form-control form-control-border frm-paymode txt-input-amount text-right chk-amount" name="amount" value="{{number_format($details->amount ?? 0,2)}}">
			</div>
