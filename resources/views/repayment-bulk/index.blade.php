...
$(function() {
	$.contextMenu({
		...
		callback: function(key, options) {
			...
			if(key == "view"){
				window.location = '/repayment-bulk/view/'+id_repayment +'?href='+'{{urlencode(url()->full())}}';
			}else if(key == "edit"){
				window.location = '/repayment-bulk/edit/'+id_repayment +'?href='+'{{urlencode(url()->full())}}';
			}else if(key == "print"){
...
function redirect_add(){
	window.location = '/repayment-bulk/create'+'?href='+'{{urlencode(url()->full())}}';
}
