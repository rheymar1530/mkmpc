...
<body class="">
    <div class="container-fluid">
                    ...
                    <div class="mx-auto">
                        ...
                        <form autocomplete='off' method="post" action="{{ route('postLogin') }}" id="frm_login">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control rounded-input log-inputs" placeholder="Username" required name="email" id="txt_user">
                            </div>
                          ...
                          <div class="row">
                            <div class="col-12 mt-3">
                                <button type="submit" class="btn btn-primary btn-block mt-2 float-right" style="border-radius: 1rem;font-size:1.2rem;letter-spacing:0.2rem" id="btn_sign_in"><b>Sign In</b></button>
                            </div>
        ...
        <div class="col-lg-7 col-md-7 col-12 order-1 order-lg-1 order-lg-1 div-section h-100" style="background-image: linear-gradient(to right,#0097b2, #7ed957);">
            <div id="particles-js" class="h-100"></div>
            <div class="pt-5" id="div-log-logo">
                <div class="text-center px-2">
                    <h3 class="fnt-weight side-txt">LEPSTA 1 MULTIPURPOSE COOPERATIVE</h3>
                    <!-- <h3 class="fnt-weight side-txt"></h3> -->
                    <!-- <br> -->
                    <h3 class="mb-0">Leon Central Elementary School</h3>
                    <h4>Leon, Iloilo</h4>
                    <img src="{{URL::asset('dist/img/LEPSTA 1 LOGO2.png')}}" class="img-logo" style="clip-path: inset(10px 10px 10px 10px);">
                </div>                        
            </div>
        </div>
    </div>
