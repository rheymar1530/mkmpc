<!-- jQuery -->
<script src="{{ URL::asset('plugins/jquery/jquery.min.js') }}" type='text/javascript'>
</script>
<!-- Bootstrap -->

<script src="{{ URL::asset('plugins/bootstrap/js/bootstrap.bundle.min.js') }}"
    type='text/javascript'></script>
<!-- AdminLTE -->
<script src="{{ URL::asset('dist/js/adminlte.js') }}" type='text/javascript'></script>
<script src="{{ URL::asset('plugins/sweetalert2/sweetalert2.min.js') }}"
    type='text/javascript'></script>
<!-- Toastr -->
<script src="{{ URL::asset('plugins/toastr/toastr.min.js') }}" type='text/javascript'>
</script>


<!--DATA TABLE-->
<script src="{{ URL::asset('plugins/datatables/jquery.dataTables.min.js') }}"
    type='text/javascript'></script>

<script src="{{ URL::asset('plugins/datatables/jquery.dataTables.min.js') }}"></script>
<script src="{{ URL::asset('plugins/datatables-bs4/js/dataTables.bootstrap4.min.js') }}">
</script>

<script src="{{ URL::asset('plugins/datatables-buttons/js/dataTables.buttons.min.js') }}">
</script>
<script src="{{ URL::asset('plugins/datatables-buttons/js/buttons.bootstrap4.min.js') }}">
</script>
...
<script src="{{ URL::asset('plugins/datatables-buttons/js/buttons.colVis.min.js') }}">
</script>

<!-- OPTIONAL SCRIPTS -->
<script src="{{ URL::asset('plugins/chart.js/Chart.min.js') }}" type='text/javascript'>
</script>

<script src="{{ URL::asset('plugins/chart.js/Chart-label.js') }}" type='text/javascript'>
</script>
<script src="{{ URL::asset('plugins/chart.js/Chart-data-labels.js') }}"
    type='text/javascript'></script>
...
<script
    src="{{ URL::asset('plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}">
</script>
<!-- Bootstrap Switch -->
<script src="{{ URL::asset('plugins/bootstrap-switch/js/bootstrap-switch.min.js') }}">
</script>
<!-- BS-Stepper -->
...
<script src="{{ URL::asset('plugins/context-menu/js/context-menu-ui-position.js') }}">
</script>
