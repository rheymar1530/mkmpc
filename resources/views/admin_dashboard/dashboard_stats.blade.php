			...
			<div class="card-body pb-1">
				<div class="row">
					...
					<div class="col-5 text-right lbl_color">
						<p class="mt-1 mb-0">{{$FILTER_MONTH}}</p>
					</div>
				</div>
				<div class="row">
					<div class="col-12">
						
						<h4 class="lbl_color mb-0">₱{{number_format($REVENUE_CURRENT_MONTH_AMOUNT,2)}}</h4>
						<?php
				...
				<div class="row">
					<div class="col-12">
						...
						<span class="font-{{($percentage < 0)?'down':'up'}} text-md">
							<i class="fas fa-arrow-{{($percentage < 0)?'down':'up'}}"></i>&nbsp;{{abs($percentage)}}% Since Last Month
						</span>
						@else
	...
	<div class="col-lg col-12 mb-3">
		<div class="card h-100">
			<div class="card-body pb-1">
				...
				<div class="row">
					<div class="col-12">
						<h4 class="lbl_color mb-0">₱{{number_format($EXPENSES_CURRENT_MONTH_AMOUNT,2)}}</h4>
						<?php
	...
	<div class="col-lg col-12 mb-3">
		<div class="card h-100">
			<div class="card-body pb-1">
				...
				<div class="row">
					<div class="col-12">
						<h4 class="lbl_color mb-0">₱{{number_format($NET_SURPLUS_CURRENT_MONTH_AMOUNT,2)}}</h4>
						<?php
			...
			<div class="card-body pb-1">
				<div class="row">
					...
					<div class="col-6 col-lg-6 text-right">
						<p class="mt-0 mb-0 lbl_color">{{$FILTER_MONTH}}</p>
					</div>
				</div>
				<div class="row">
					<div class="col-6">
						<h5 class="lbl_color mb-0 pt-2">{{$NO_LOAN_TRANSACTION}}</h5>
					</div>
					<div class="col-6">
						<p class="lbl_color mb-0 text-md" >Total Principal</p>
						<p class="lbl_color mb-0 mt-n1" style="font-size:1.1rem">₱{{number_format($TOTAL_PRINCIPAL,2)}}</p>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-6 col-6">
						...
						?>
						@if($percentage != 0)
						<span class="font-{{($percentage < 0)?'down':'up'}}" style="font-size: 0.9rem;">
							<i class="fas fa-arrow-{{($percentage < 0)?'down':'up'}}"></i>&nbsp;{{abs($percentage)}}% Since Last Month
						</span>
						@else
						<span class="text-muted text-md">
