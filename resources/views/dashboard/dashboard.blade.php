		...
		<div class="col-lg-5 d-flex  mt-2">
			<div class="card flex-fill card-cust">
				...
				<div class="card-body">
					...
					@include('dashboard.loan_application')
				</div>
			</div>
		</div>
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-{{$con['col']}} col-{{$con['col']}} div_center">
									<a href="{{ $con['href'] ?? 'javascript:void(0)' }}" style="font-size: <?php echo $con['font-size']??'' ?> "> <span class="badge badge-lbl bg-light rounded-pill {{$con['class']??''}}">{{$con['description']}}</span></a>
								</div>
								@endforeach
							</div>
							<!-- END LABEL -->
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row mt-2">
								@foreach($content as $con)
								<div class="col-lg-{{$con['col']}} col-{{$con['col']}} div_center">
									<a href="{{ $con['href'] ?? 'javascript:void(0)' }}" style="font-size: <?php echo $con['font-size']??'' ?> "><span class="badge badge-lbl bg-light rounded-pill"> {{$con['description']}}</span></a>
								</div>
								@endforeach
							</div>
							<!-- END LABEL -->								
											...
											<!-- <li class="mt-1"> -->
												<div class="row mb-1">
													...
													<div class="col-lg-12 div_left">
														<a class="a_label" style="font-size: <?php echo $con['font-size']??'' ?>" href="{{ $con['sub'][$i]['href'] ?? '' }}"><span class="badge badge-lbl bg-light rounded-pill text-left"> {{$con['sub'][$i]['description'] ?? ''}}</span></a>
													</div>
							...
							<div class="col-lg-12 mt-3">
								<ul class="main_list">
									...
									@if(isset($con['sub'][$i]['description']))
										...
										<div class="row mb-2">
											<div class="col-lg-12 div_left">
												<a class="a_label" style="font-size: <?php echo $con['font-size']??'' ?>" href="{{ $con['sub'][$i]['href'] ?? '' }}"><span class="badge badge-lbl bg-light rounded-pill"> {{$con['sub'][$i]['description'] ?? ''}}</span></a>
											</div>
