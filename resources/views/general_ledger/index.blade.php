			...
			<div class="card">
				<div class="card-body">
					...
					<div class="col-md-{{$col}}">
						<h4 class="text-center head_lbl mb-4">{{$title_head}}</h4>
...
<!-- 							<div class="btn-group ml-1">
						...
						<table class="table table-bordered table-stripped table-head-fixed table-hover tbl_accounts">
							...
							<tbody>
								...
								@else
								<tr>
									<th colspan="{{($filter_type==2)?7:3}}" style="text-align:center;">No Record Found</th>
								</tr>
								@endif
							</tbody>
						</table>  
...
<script type="text/javascript">
	...
	function generate_gl(type,export_type){
		...
		if(accounts.length == 0 && '{{$filter_type}}' == 2){
			Swal.fire({
