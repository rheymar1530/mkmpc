...
<body>
		...
		<p style="margin-top:-3px" ><span class="head_others">{{config('variables.coop_district')}}</span></p>
		<p style="margin-top:10px" ><span class="head_others">{{config('variables.coop_address')}}</span></p>
		<br>
		<h3 style="font-size:18px" class="head"><span>CASH DISBURSEMENT VOUCHER</span></h3>
		<br>
	</div>
