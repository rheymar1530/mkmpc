            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <div class="card c-border row_net">
                        <div class="card-body">
                            <h6 class="lbl_color"><u>Payslip {{$i+1}}</u></h6>
                            <div class="form-row d-flex align-items-end mt-3">
                                <div class="form-group col-md-6 col-6">
                                    <label class="lbl_color">Date Period</label>
                                    <input type="date" name="" required class="form-control frm-net frm-requirements" key="period_start" value="{{$net_pays[$i]->period_start ?? ''}}">
                                </div>
                                <div class="form-group col-md-6 col-6">
                                    <label class="lbl_color">&nbsp;</label>
                                    <input type="date" name="" required class="form-control frm-net frm-requirements" key="period_end" value="{{$net_pays[$i]->period_end ?? ''}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="lbl_color">Amount</label>
                                    <input type="text" name="" required class="form-control frm-net class_amount frm-requirements" value="{{$net_pays[$i]->amount ?? '0.00'}}" key="amount">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody>
                        @for($i=0;$i<$loan_service->no_comakers;$i++)
                            <tr class="row_comaker">
                                ...
                                <td>
                                    <select id="sel_comaker_{{$i+1}}" class="form-control frm-comakers frm-requirements p-0 select2 sel_comaker cus-font"  key='id_member' required onchange="check_comaker_duplicate(this,'<?php echo $i;?>')">
                                        <?php
    ...
    <div class="card c-border">
       ...
       <!--      <div class="">
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" rows="3" style="resize:none;" key="loan_remarks" id="txt_loan_remarks">{{$loan_service->loan_remarks ?? ''}}</textarea>
            </div>
        </div>
    </div>
</div>
