...
<body <?php echo ($load)?'onload="window.print();"':'';?> >
	<?php
		$class=[
			'id_image'=>[
				'label' =>'RECEIVER ID',
				'properties' =>" height='200px' width='300px'" 
			],
			'image'=>[
				'label' =>'POD',
				'properties' =>" height='110px' width='300px'" 
			],
			'signature'=>[
				'label'=>'SIGNATURE',
				'properties' =>" height='90px' width='220px'" 
			]
		];
	?>
	        		<header>
	...
	<div class="row" style="page-break-inside: auto;border-top: 1px solid;">
			@if($type_count >= 2)
					@foreach($attachments as $hawb_key=>$att)
						<table style="page-break-inside: avoid !important;" class="ins_table" width="100%">
										...
										<td style="width:33% !important">
											...
											@if($att['attachments'][$k] != "")
												<div style="margin-top:5px">
													<img src="{{$base64}}" alt="image" height="200px" width="300px">
												</div>
											@else
												<div style="margin-top:5px;width: 300px;"></div>
