		...
		<form id="generate_summary">
			<div class="modal-content " style="">
				<div class="modal-header panel_header">
					<h4 class="modal-title"><i class="fa fa-eye"></i> Change Summary</h4>
				...
				<div class="form-horizontal" >   
					<div class="form-group row" style="margin-top:10px">
						...
						<div class="form-group row">
							<label class="col-md-2 control-label col-form-label col-md-cus" style="text-align: left">&nbsp;</label>
							<div class="col-md-4">
								<div class="form-check">
...
<script type="text/javascript">
	$('#generate_summary').submit(function(e){
		...
		print_page('/change/summary/created/'+$('#txt_date_summary_start').val()+'/'+$('#txt_date_summary_end').val()+'/'+(($('#chk_cancel').prop("checked"))?1:0));
