...
<body>
	<header>
		<div class="header" style="margin-top: 100px !important;">
			<p style="font-size: 17px;margin-top: -15px"><b>{{config('variables.coop_name')}}</b></p>
			<p style="font-size: 17px;margin-top: -21px">{{config('variables.coop_address')}}</p>
			<p style="font-size: 16px;margin-top: -18px">STATEMENT OF CHANGE IN EQUITY, STATUTORY FUND AND GRANTS AND DONATIONS</p>
			<p></p>
			<p></p>
		</div> 
	</header>
	<div class="row">
		@include('changes_equity.table')
	</div>
