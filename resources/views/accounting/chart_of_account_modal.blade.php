        ...
        <div class="modal-content">
            <form id="frm_chart">
                                            ...
                                            <div class="col-sm-12 p-1">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_cat">
                                                            ...
                                                            <option value="{{$cat->id_chart_account_category}}">{{$cat->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_line_item">
                                                            @foreach($line_item as $line)
                                                                <option value="{{$line->id_chart_account_line_item}}">{{$line->description}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_normal">
                                                            ...
                                                            <option value="{{$norm->id_chart_account_normal}}">{{$norm->description}}</option>
                                                            @endforeach
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_type">
                                                            @foreach($type as $t)
                                                            <option value="{{$t->id_chart_account_type}}">{{$t->description}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_sub_type">
                                                            ...
                                                            <option value="{{$sub->id_chart_account_subtype}}">{{$sub->description}}</option>
                                                            @endforeach
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_dep_account">
                                                         ...
                                                         @foreach($charts_sel as $ch)
                                                         <option value="{{$ch->id_chart_account}}">{{$ch->account}}</option>
                                                         @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-8">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_cash_flow">
                                                            ...
                                                            @foreach($cfs as $v=>$cf)
                                                            <option value="{{$cf->id_cash_flow}}">{{$cf->type}} {{$cf->sub_type}} > {{$cf->description}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                   <div class="form-group col-md-4">
                                                        ...
                                                        <select class="form-control form-in-text in p-0 sel_status">
                                                            @foreach($status_list as $v=>$st)
                                                            <option value="{{$v}}">{{$st}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                ...
                <div class="modal-footer" style="padding:5px;padding-left: 10px;">
                    @if($credential->is_edit || $credential->is_create)
