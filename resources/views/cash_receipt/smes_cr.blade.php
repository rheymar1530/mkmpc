...
<body onload=";">
	...
	<!-- 		        <tr>
		 	...
		 	<table class="table_width add_border" style="" border="0" cellspacing="0" cellpadding="0">
		 		<tr>
		 				<!-- cash -->
		 				<td class="table-column" style="width:1.5cm !important;"><div class="item add_border" style="width:1.5cm !important;padding-left: 1mm;padding-top: 1.5mm;">{{($cash_receipt->id_paymode==1)?'x':''}}</div></td>
		 				<!-- bank -->
		 				<td class="table-column"><div class="item add_border" style="padding-left:0.5mm;padding-top: 1.5mm;">{{($cash_receipt->id_paymode==3)?'x':''}}</div></td>
		 		</tr>
		 		<tr>
		 				<!-- cash -->
		 		...
		 		<tr>
		 				<!-- check -->
		 				<td class="table-column" style="width:1.5cm !important;"><div class="item item_7_np add_border" style="width:1.5cm !important;padding-left: 1mm;">{{($cash_receipt->id_paymode==2)?'x':''}}</div></td>
		 				<!-- epayment -->
		 				<td class="table-column"><div class="item add_border item_7_np" style="padding-left:0.5mm;padding-top: -10mm !important;">{{($cash_receipt->id_paymode==4)?'x':''}}</div></td>
		 		</tr>
		 	</table>
		</div>
		<div class="column border-right add_border" id="col-grp-2" style="padding:0px !important">
			<table class="or_details add_border" style="" border="0" cellspacing="0" cellpadding="0">
			        ...
			        <tr>
		 				 ...
		 				 <td class="table-column" style="width:3.8cm"><div class="item add_border item_7">{{$cash_receipt->transaction_date}}</div></td>
		 			</tr>

		 			<!-- Received From -->
		 			<tr>
		 				 <!-- <td class="table-column" style="width:2.2cm"><div class="item item_6 add_border"></div></td> -->
		 				 <td class="table-column" colspan="3"><div class="item add_border item_6" style="padding-left: 2.2cm;">{{$cash_receipt->member_name}}</div></td>
		 			</tr>

		 			<!-- With TIN -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item add_border" style="padding-left: 1.3cm;">{{$cash_receipt->tin}}</div></td>
		 			</tr>	

		 			<!-- Address   -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item item_55 add_border" style="padding-left: 2.5cm;">{{$cash_receipt->address}}</div></td>
		 			</tr>	 			

		 			<!-- Engaged in -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item item_55 add_border" style="padding-left: 1.8cm;">{{$cash_receipt->engaged_in}}</div></td>
		 			</tr>	

		 			<!-- Sum of -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item add_border" style="padding-left: 1.8cm;" id="sum_text_worded"></div></td>
		 			</tr>	

		 			<!-- Sum of word and amount-->
		 			<tr>
		 				 <td class="table-column" colspan="2" style="width:10cm !important"><div class="item item_6 add_border"></div></td>
		 				 <td class="table-column" ><div class="item item_6 add_border" id="sum_number_text"></div></td>
		 			</tr>	

		 			<!-- In partial -->
		 			<tr>
		 				 <td class="table-column" colspan="3"><div class="item add_border item_6" style="padding-left: 4cm;"></div></td>
		 			</tr>
