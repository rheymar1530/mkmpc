        ...
        <div class="modal-content">
            <form id="frm_change_status">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title head_lbl">Cancel Asset ID# {{$asset->id_asset}}
...
function post_status(){
        $.ajax({
            type      :     'POST',
            url       :     '/asset/post/cancel',
            data      :     {'id_asset'  :  '<?php echo $asset->id_asset ?? 0 ?>',
            ...
            success   :     function(response){
                            ...
                            if(response.RESPONSE_CODE == "SUCCESS"){
                                Swal.fire({
                                    title: "{{$module_title}} Successfully Cancelled",
                                    text: '',
                                    icon: 'success',
