		...
		<div class="card-body col-md-12">
			<div class="row">
				<div class="col-md-12 col_form" style="padding-left: 20px">
					...
					<p class="p_add_text">If you have a question you can contact us at <a href="tel:{{config('variables.coop_contact')}}">{{config('variables.coop_contact')}}</a> or by email at <a href="mailto:{{config('variables.coop_email')}}">{{config('variables.coop_email')}}</a>.</p>
					<hr>
					<form id="frm_post_password" autocomplete='off' method="post" action="{{ route('PostPasswordReset') }}">
						<div class="row">
							<div class="col-md-6">
								...
								<input type="hidden" name="request_token" value="{{$details->token}}">
								<input type="hidden" name="request_id" value="{{$details->id_tbl_password_reset}}">
								<input type="hidden" name="request_id_user" value="{{$details->id_user}}">
