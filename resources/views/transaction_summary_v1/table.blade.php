...
<table class="table table-bordered table-stripped table-head-fixed table-hover tbl_accounts tbl_gl" style="margin-top:20px">
	...
	<thead>
		<tr style="text-align:center;" class="table_header_dblue_cust">
			<th class="table_header_dblue_cust" colspan="{{($type=='Cash Receipt Voucher')?7:7}}" style="text-align:center;font-size: 17px">{{strtoupper($type)}}</th>
		</tr>
		<tr style="text-align:center;border-bottom:1px solid" class="table_header_dblue_cust tbl_head">
			...
			<th class="table_header_dblue_cust" style="width:10cm">Description</th>
			<th class="table_header_dblue_cust" style="width: 2cm;">Reference</th>
	...
	<tbody>
		...
		<tr class="row_total" style="border-top: 1px solid;">
			<th colspan="{{($type=='Cash Receipt Voucher')?5:5}}" style="text-align:left;">TOTAL</th>
			<th class="class_amount">{{number_format($total,2)}}</th>
			<th></th>
		</tr>
		@else
			<tr>
				<th colspan="{{($type=='Cash Receipt Voucher')?8:7}}" style="text-align:center;">No data</th>
			</tr>
		@endif
