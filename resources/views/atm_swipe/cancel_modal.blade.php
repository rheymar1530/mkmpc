        ...
        <div class="modal-content">
            <form id="form_cancel_submit">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4 head_lbl">Cancel ATM Swipe ID# 
                        <span id="spn_id_atm_swipe"></span>
                    ...
                    <div class="col-md-12">
                        <div class="form-row" style="margin-top:10px">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control form-control-border" rows="3" style="resize:none;" id="txt_cancel_reason"></textarea>
...
<script type="text/javascript">
    ...
    function show_cancel_modal(id_atm_swipe){
        to_be_cancel_holder = id_atm_swipe;
        $('#spn_id_atm_swipe').text(to_be_cancel_holder);
    ...
    function post_cancel(){
        $.ajax({
            type          :          "POST",
            url           :          "/atm_swipe/cancel",
            data          :          {"id_atm_swipe"  :   to_be_cancel_holder,
            ...
            success       :          function(response){
                                     ...
                                     if(response.RESPONSE_CODE == "SUCCESS"){
                                        Swal.fire({
                                            title: "ATM Swipe successfully cancelled",
                                            text: '',
                                            icon: 'success',
