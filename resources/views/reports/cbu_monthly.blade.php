...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<h2 class="head_lbl text-center">Summary of CBU Per Member (Monthly)</h2>
				<div class="row mt-3">
...
<script type="text/javascript">
	...
	function submit_filter(type){
		...
		if(type == 1){
			...
			window.location = '/cbu/monthly?'+link_param;			
		}else if(type==2){
			window.open('/cbu/monthly/export?'+link_param,'_blank');
		}else if(type == 3){
			window.open('/cbu/monthly/export-excel?'+link_param,'_blank');
		}
