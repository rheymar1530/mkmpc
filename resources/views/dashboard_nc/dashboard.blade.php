	...
	<div class="row div_dashboard">
		...
		<div class="col-lg-5 d-flex  mt-4">
			<div class="card flex-fill card-cust">
				...
				<div class="card-body">
					@include('dashboard_nc.loan_application')
				</div>
			</div>
		</div>
		...
		<div class="col-lg-7 d-flex  mt-4">
			<div class="card flex-fill">
				<div class="card-header border-0 div_center">
					<h1 class="mt-n4-5"><span class="badge bg-gradient-success2">Loan Loan Payment</span></h1>
				</div>
				<div class="card-body">
					@include('dashboard_nc.repayment')
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-6">
			<div class="row p-0">
				<div class="col-lg-12 first_o mt-4">
					<div class="card">
						<div class="card-header border-0 div_center">
							...
							<h1 class="mt-n4-5"><span class="badge bg-gradient-primary2">Cash Transactions</span></h1>
						</div>
						<div class="card-body">
							<?php
							$content = array(
								array('description'=>'IN','icon'=>'in.png','col'=>2,'width'=>'40px','font-size'=>'25px'),
							...
							<div class="row">
								...
								<div class="col-lg-{{$con['col']}} col-{{$con['col']}} div_center">
									<label style="font-size: <?php echo $con['font-size']??'' ?> "> {{$con['description']}}</label>
								</div>
								@endforeach
							</div>
							<!-- END LABEL -->
							...
							<?php
							$content = array(
								array('description'=>'OUT','icon'=>'up.png','col'=>2,'width'=>'40px','font-size'=>'25px'),
				...
				<div class="col-lg-12 fourth_o mt-4">
					<div class="card">
						<div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-danger2">Bank</span></h1>
						</div>
						<div class="card-body">
							<?php
							$content = array(
				...
				<div class="col-lg-12 second_o mt-4">
					<div class="card">
						<div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-dark">Member</span></h1>
						</div>
						<div class="card-body">
							<?php
							$content = array(
				...
				<div class="col-lg-12 fifth_o mt-4">
					<div class="card">
						<div class="card-header border-0 div_center">
							...
							<h1 class="mt-n4-5"><span class="badge bg-gradient-primary2">Employee</span></h1>
						</div>
						<div class="card-body">
							<?php
							$content = array(
		...
		<div class="col-lg-6">
			<div class="row p-0">
				<div class="col-lg-12 third_o mt-4" id="div_accounting">
					<div class="card">
						<div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-danger2">Accounting</span></h1>
						</div>
						<div class="card-body">
							<?php
							$content = array(
				...
				<div class="col-lg-12 fifth_o mt-4" id="div_asset">
					<div class="card">
						<div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-danger-primary2">Assets</span></h1>
						</div>
						<div class="card-body">
				...
				<div class="col-lg-12 fourth_o mt-4">
					<div class="card" id="div_rep">
						<div class="card-header border-0 div_center">
							<h1 class="mt-n4-5"><span class="badge bg-gradient-success2">Reports</span></h1>
						</div>
						<div class="card-body">
							<?php
							$l =5;
