        ...
        <div class="modal-content">
            <form id="frm_change_status">
                <div class="modal-header" style="padding:5px;padding-left: 10px;">
                    <h5 class="modal-title h4">Cancel Asset Disposal ID# {{$details->id_asset_disposal}}</h5>
...
function post_status(){
        $.ajax({
            type      :     'POST',
            url       :     '/asset_disposal/post/cancel',
            data      :     {'id_asset_disposal'  :  '<?php echo $details->id_asset_disposal ?? 0 ?>',
            ...
            success   :     function(response){
                            ...
                            if(response.RESPONSE_CODE == "SUCCESS"){
                                Swal.fire({
                                    title: "Asset Disposal Successfully Cancelled",
                                    text: '',
                                    icon: 'success',
